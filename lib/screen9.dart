                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5,),
                        Text("about.me/imthepkr",style: TextStyle(fontSize: 12,letterSpacing: 2),),
                      ],
                    ),
                    SizedBox(height: 20,),
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5,),
                        Text("+919876543210",style: TextStyle(fontSize: 12,letterSpacing: 2),),
                      ],
                    ),
                    SizedBox(height: 20,),
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5,),
                        Text("youtube.com/mtechviral",style: TextStyle(fontSize: 12,letterSpacing: 2),),
                      ],
                    ),
                  ],
                ),
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5,),
                        Text("New Delhi",style: TextStyle(fontSize: 12,letterSpacing: 2),),
                      ],
                    ),
                    SizedBox(height: 20,),
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5,),
                        Text("mtechvial@gmail.com",style: TextStyle(fontSize: 12,letterSpacing: 2),),
                      ],
                    ),
                    SizedBox(height: 20,),
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5,),
                        Text("facebook.com/imthepk",style: TextStyle(fontSize: 12,letterSpacing: 2),),
                      ],
                    ),
                  ],
                ),
